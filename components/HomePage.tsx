    ...
    <div className="container mx-auto px-6 py-16 sm:py-24">
      ...
      <section className="text-center mb-20">
        ...
        <button 
          ...
          className="bg-secondary text-white font-bold py-3 px-8 rounded-full text-lg hover:bg-blue-500 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-secondary/40 focus:outline-none focus:ring-4 focus:ring-secondary/50"
        >
          Explore Tools
        </button>
      </section>
